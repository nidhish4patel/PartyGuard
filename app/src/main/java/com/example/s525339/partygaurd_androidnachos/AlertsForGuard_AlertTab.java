 ...
 * This class holds the information for the guard user alerts.
 */
public class AlertsForGuard_AlertTab {
    ...
    public AlertsForGuard_AlertTab(String incidence, String date, String name, String fraternity, String location, String comments, String status, String time, String imageURL,String age, String basicFullName,String issueID) {
